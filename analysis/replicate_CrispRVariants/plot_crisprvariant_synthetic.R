...
pdir <- "./replicate_CrispRVariants/simulation"
...
bams <- file.path("./replicate_CrispRVariants/simulation", paste0(base, ".bam"))
...
data.table::fwrite(result, "../figures/indel_rate_vs_offtarget.csv")
p <- ggplot(result) +
